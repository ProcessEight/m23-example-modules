...
/**
 * Class CreateAdminhtmlTemplateFolderStage
 *
 * This stage creates the folder VENDOR_NAME/MODULE_NAME/view/adminhtml/template/
 *
 */
class CreateAdminhtmlTemplateFolderStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAdminhtmlTemplateFolderStage';
    ...
    public function processStage(array $payload) : array
    {
        $absolutePathToFolder = $this->folder->getAbsolutePathToFolder(
            $payload,
            $this->id,
            'view' . DIRECTORY_SEPARATOR . 'adminhtml' . DIRECTORY_SEPARATOR . 'templates'
        );
