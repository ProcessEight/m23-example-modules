...
/**
 * Class CreateModelPhpInterfaceStage
 *
 * Creates an Api/Data/{{ENTITY_NAME}}Interface.php file
 *
 */
class CreateModelPhpInterfaceStage extends BaseStage
{
    /**
     * @var string
     */
    public $id = 'createModelPhpInterfaceStage';
    ...
    public function processStage(array $payload) : array
    {
        ...
        $artefactFileName  = str_replace(
            ...
            '{{ENTITY_NAME}}Interface.php'
        );
        $templateFilePath  = $this->template->getTemplateFilePath(
            '{{ENTITY_NAME}}Interface.php.template',
            $subfolderPath
        );
