...
/**
 * Class CreateFrontendTemplatePhtmlFileStage
 *
 * Creates a VENDOR_NAME/MODULE_NAME/view/frontend/templates/TEMPLATE_NAME.phtml file
 * Assumes that the VENDOR_NAME/MODULE_NAME/view/frontend/templates/ folder already exists
 *
 */
class CreateFrontendTemplatePhtmlFileStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createFrontendTemplatePhtmlFileStage';
    ...
    {
        $subfolderPath     = 'view' . DIRECTORY_SEPARATOR . 'frontend' . DIRECTORY_SEPARATOR . 'templates';
