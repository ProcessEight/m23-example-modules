...
/**
 * Class CreateObserverFolderStage
 *
 * Creates a Observer/ folder
 *
 */
class CreateObserverFolderStage extends BaseStage
{
    /**
     * @var string
     */
    public $id = 'createObserverFolderStage';
    ...
    public function processStage(array $payload) : array
    {
        ...
        $payload['messages'][] = "Created Observer folder at <info>{$absolutePathToFolder}</info>";
