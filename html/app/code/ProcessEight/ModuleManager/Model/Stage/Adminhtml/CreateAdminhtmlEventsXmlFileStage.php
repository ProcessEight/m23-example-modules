...
/**
 * Class CreateAdminhtmlEventsXmlFileStage
 *
 * Creates a VENDOR_NAME/MODULE_NAME/etc/adminhtml/events.xml file
 * Assumes that the VENDOR_NAME/MODULE_NAME/etc/adminhtml/ folder already exists
 *
 */
class CreateAdminhtmlEventsXmlFileStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAdminhtmlEventsXmlFileStage';
