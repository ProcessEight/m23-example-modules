...
/**
 * Class CreateAdminhtmlBlockPhpClassFileStage
 *
 * Creates a PHP class file.
 *
 * @package ProcessEight\ModuleManager\Model\Stage
 */
class CreateAdminhtmlBlockPhpClassFileStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAdminhtmlBlockPhpClassFileStage';
    ...
    public function processStage(array $payload) : array
    {
        $artefactFilePath  = $this->folder->getAbsolutePathToFolder(
            $payload,
            $this->id,
            'Block' . DIRECTORY_SEPARATOR . 'Adminhtml' . ucfirst($payload['config'][$this->id]['values'][ConfigKey::BLOCK_DIRECTORY_NAME])
        );
        ...
        $templateFilePath  = $this->template->getTemplateFilePath(
            ...
            'Block' . DIRECTORY_SEPARATOR . 'Adminhtml'
        );
