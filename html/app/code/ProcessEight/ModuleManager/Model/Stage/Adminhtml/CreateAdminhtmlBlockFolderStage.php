...
/**
 * Class CreateAdminhtmlBlockFolderStage
 *
 * Creates the module folder
 *
 * @package ProcessEight\ModuleManager\Model\Stage
 */
class CreateAdminhtmlBlockFolderStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAdminhtmlBlockFolderStage';
