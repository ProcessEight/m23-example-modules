...
/**
 * Class CreateAdminhtmlLayoutFolderStage
 *
 * This stage creates the folder VENDOR_NAME/MODULE_NAME/view/adminhtml/layout/
 *
 */
class CreateAdminhtmlLayoutFolderStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    ...
    public function processStage(array $payload) : array
    {
        $absolutePathToFolder = $this->folder->getAbsolutePathToFolder(
            $payload,
            $this->id,
            'view' . DIRECTORY_SEPARATOR . 'adminhtml' . DIRECTORY_SEPARATOR . 'layout'
        );
