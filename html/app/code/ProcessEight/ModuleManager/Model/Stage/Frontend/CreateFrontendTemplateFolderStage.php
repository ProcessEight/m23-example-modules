...
/**
 * Class CreateFrontendTemplateFolderStage
 *
 * This stage creates the folder VENDOR_NAME/MODULE_NAME/view/frontend/template/
 *
 */
class CreateFrontendTemplateFolderStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createFrontendTemplateFolderStage';
    ...
    public function processStage(array $payload) : array
    {
        $absolutePathToFolder = $this->folder->getAbsolutePathToFolder(
            $payload,
            $this->id,
            'view' . DIRECTORY_SEPARATOR . 'frontend' . DIRECTORY_SEPARATOR . 'templates'
        );
