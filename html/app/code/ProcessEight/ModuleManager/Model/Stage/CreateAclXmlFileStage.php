...
/**
 * Class CreateAclXmlFileStage
 *
 * Creates a VENDOR_NAME/MODULE_NAME/etc/acl.xml file
 * Assumes that the VENDOR_NAME/MODULE_NAME/etc/ folder already exists
 *
 */
class CreateAclXmlFileStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAclXmlFileStage';
    ...
    public function getTemplateVariables(string $stageId, array $payload) : array
    {
        return [
            ...
            '{{CONTROLLER_ACTION_NAME_LCFIRST}}'    => lcfirst($payload['config'][$stageId]['values'][ConfigKey::CONTROLLER_ACTION_NAME]),
