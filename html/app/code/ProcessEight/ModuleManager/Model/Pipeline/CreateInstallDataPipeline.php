...
/**
 * Class CreateInstallDataPipeline
 *
 */
class CreateInstallDataPipeline extends BasePipeline
{
    /**
    ...
    /**
     * @var \ProcessEight\ModuleManager\Model\Stage\CreateInstallDataPhpClassStage
     */
    private $createInstallDataPhpClassStage;
     ...
     * @param \ProcessEight\ModuleManager\Model\Stage\CreateInstallDataPhpClassStage  $createInstallDataPhpClassStage
     */
    public function __construct(
        ...
        \ProcessEight\ModuleManager\Model\Stage\CreateInstallDataPhpClassStage $createInstallDataPhpClassStage
    ) {
        ...
        $this->createInstallDataPhpClassStage  = $createInstallDataPhpClassStage;
    }
    ...
    public function processPipeline(array $payload) : array
    {
        ...
        $pipeline = $this->pipeline
            ...
            ->pipe($this->createInstallDataPhpClassStage);
