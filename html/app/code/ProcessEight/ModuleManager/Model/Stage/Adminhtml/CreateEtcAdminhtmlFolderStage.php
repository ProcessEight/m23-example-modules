...
/**
 * Class CreateEtcAdminhtmlFolderStage
 *
 * Creates an etc folder
 *
 */
class CreateEtcAdminhtmlFolderStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createEtcAdminhtmlFolderStage';
    ...
    /**
     * CreateEtcAdminhtmlFolderStage constructor.
     *
