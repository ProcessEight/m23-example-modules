 ...
 * Assumes that the VENDOR_NAME/MODULE_NAME/view/adminhtml/layout/ folder already exists
 */
class CreateAdminhtmlLayoutXmlFileStage extends BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAdminhtmlLayoutXmlFileStage';
    ...
    {
        $subfolderPath     = 'view' . DIRECTORY_SEPARATOR . 'adminhtml' . DIRECTORY_SEPARATOR . 'layout';
