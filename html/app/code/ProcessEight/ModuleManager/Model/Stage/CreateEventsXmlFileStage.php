...
/**
 * Class CreateEventsXmlFileStage
 *
 * Creates a VENDOR_NAME/MODULE_NAME/etc/events.xml file
 * Assumes that the VENDOR_NAME/MODULE_NAME/etc/ folder already exists
 *
 */
class CreateEventsXmlFileStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createEventsXmlFileStage';
