...
class Mysql extends \Zend_Db_Adapter_Pdo_Mysql implements AdapterInterface
{
    ...
    public function createTemporaryTableLike($temporaryTableName, $originTableName, $ifNotExists = false)
    {
        ...
        $sql            = sprintf('CREATE TEMPORARY TABLE %s %s LIKE %s', $ifNotExistsSql, $temporaryTable,
            $originTable);
    ...
    public function isTableExists($tableName, $schemaName = null)
    {
        ...
        // Ideally we should hit this bit as infrequently as possible
        // (the fewer db queries the better)
        $fromDbName = 'DATABASE()';
        if ($schemaName !== null) {
