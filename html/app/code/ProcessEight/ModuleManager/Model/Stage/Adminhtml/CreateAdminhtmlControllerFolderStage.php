...
/**
 * Class CreateAdminhtmlControllerFolderStage
 *
 * Creates the VENDOR_NAME/MODULE_NAME/Controller/Adminhtml/ folder
 *
 */
class CreateAdminhtmlControllerFolderStage extends \ProcessEight\ModuleManager\Model\Stage\BaseStage
{
    /**
     * @var string
     */
    public $id = 'createAdminhtmlControllerFolderStage';
    ...
    public function configureStage(array $payload) : array
    {
        ...
        $payload['config'][$this->id]['options'][ConfigKey::CONTROLLER_DIRECTORY_NAME] = [
            ...
            'question'                => '<question>Controller directory name (the \'product\' in \'/admin/catalog/product/edit\') [example]:</question> ',
    ...
    public function processStage(array $payload) : array
    {
        $absolutePathToFolder = $this->folder->getAbsolutePathToFolder(
            ...
            'Adminhtml' . DIRECTORY_SEPARATOR .
            ucfirst($payload['config'][$this->id]['values'][ConfigKey::CONTROLLER_DIRECTORY_NAME])
        );
